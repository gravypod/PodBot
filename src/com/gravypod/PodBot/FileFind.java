...
public class FileFind extends CommandClass {
	 ...
	 * 
	 * @param fileName - command name that was run
	 * @return
	 * 
	 */
	 ...
	 * If it is multi-line use ArrayFileContent!
	 * 
	 * @param fileName - command name that was run.
	...
	/**
	 * 
	 * Returns an array list of lines that were in a command file.
	 * It is split at what ever PodBot.lineSep is.
	 * 
	 * @param fileName - command name that was run.
	 * @param sender - Sender of the command.
	 * @param channel - Channel the command was sent in.
